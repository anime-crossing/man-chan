...
class Music(CommandBase):
    ...
    async def create_playlist(
        self, inter: disnake.ApplicationCommandInteraction, playlist_name: str
    ):
    ...
    async def delete_playlist(
        self, inter: disnake.ApplicationCommandInteraction, playlist_id: int
    ):
    ...
    async def add_playlist(
        ...
        playlist_id: int,
        add_type: PlaylistAddType,
    ):
        await Music_Interactions.add_playlist_interaction(
            inter, playlist_id, PlaylistAddType(add_type)
        )
